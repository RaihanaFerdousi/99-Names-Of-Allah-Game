    ...
    <div className="bg-white/80 backdrop-blur-lg shadow-2xl border-b border-amber-200 sticky top-0 z-50">
      <div className="max-w-6xl mx-auto px-6 py-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-5xl arabic-text bg-gradient-to-r from-blue-800 via-emerald-600 to-amber-600 bg-clip-text text-transparent mb-3 animate-fadeIn">
            أَسْمَاءُ اللهِ الْحُسْنَى
          </h1>
          <p className="text-gray-700 text-lg font-medium mb-4">The 99 Beautiful Names of Allah</p>
          <div className="flex justify-center items-center gap-4">
            <span className="bg-gradient-to-r from-emerald-100 to-emerald-50 text-emerald-800 px-6 py-2 rounded-full text-base font-bold shadow-lg border border-emerald-200">
        ...
        <div className="flex flex-wrap justify-center gap-4">
          {modes.map(({ id, label, icon: Icon }) => (
            <button
              ...
              className='nav-item flex items-center gap-3 px-6 py-3 border rounded-2xl font-bold transition-all duration-300 transform hover:scale-105'
            >
